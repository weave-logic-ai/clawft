---
title: Release Notes
description: Complete version history for WeftOS from initial development through v0.5.1.
---
...
- Fixed all incorrect URLs (github.com/clawft/clawft → weave-logic-ai/weftos, ghcr.io same)
- Updated test badge (3,300+ → 3,900+), crate count (22 → 23)
