...
description: Complete catalog of WeftOS console commands organized by namespace
---
...
System-level commands handled directly by the ShellAdapter (not service-routed).
