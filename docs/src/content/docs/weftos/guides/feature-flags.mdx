---
title: Feature Flags
description: Complete reference for all Cargo feature flags across the 22 workspace crates.
---
...
- [Configuration Reference](/weftos/guides/configuration) -- runtime config
- [Installation](/weftos/getting-started/installation) -- build instructions with feature examples
- [Kernel Phases](/weftos/kernel-phases) -- kernel phase descriptions
