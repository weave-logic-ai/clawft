---
title: Installation
description: Full installation guide for WeftOS including source builds, Docker, ONNX embeddings, and debug builds.
---
...
See the [feature flags guide](/weftos/guides/feature-flags) for the complete
feature reference.
...
For detailed Docker deployment options, see the
[Docker deployment guide](/weftos/guides/deployment-docker).
...
- [Feature Flags](/weftos/guides/feature-flags) -- all compile-time feature flags
