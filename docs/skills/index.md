...
Autogenerated skills (pattern detector → pending SKILL.md) and their
**filesystem allowlist** load-time intersection are documented in
[Autogen filesystem allowlist](autogen.md) (WEFT-75).
