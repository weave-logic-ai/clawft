...
| `docs/adr/adr-071-webview-substrate-publish-gate.md` | **new** decision |
| `docs/adr/README.md` | Index + Security category |
| `.planning/reviews/0.7.0-release-gate/15-mcp-integration.md` | Open Q closed with WEFT-496 / ADR-071 |
...
| Decide: tighten tools vs revise viewer-only | **Yes** — revise invariant (ADR-071); keep tools |
| Comment block in `extension.ts` updated | **Yes** |
| Audit row closed with WEFT-N | **Yes** — WEFT-496 / ADR-071 |
