...
export const MEDICAL_ATTENTION_CONFIG = {
    ...
    precision: 'float32', // Full precision (medical data critical)
...
export async function findSimilarCases(patientScan, // MRI/CT scan embeddings
medicalDatabase, // HNSWGraph type
applyAttention, runEnsemble, calculateEnsembleConfidence, minConfidence = 0.95) {
...
export function adaptConfigToUrgency(baseConfig, urgency) {
    switch (urgency) {
        case 'routine':
            return {
                ...baseConfig,
...
export function validateMedicalData(scan) {
    return {
...
function checkDICOMHeaders(scan) { return true; }
function checkResolution(scan) { return true; }
function assessContrast(scan) { return 0.95; }
function detectArtifacts(scan) { return 0.02; }
function verifyCalibration(scan) { return true; }
//# sourceMappingURL=medical-imaging.js.map