...
class VectorBenchmark {
    dimensions;
    vectorCount;
    constructor(dimensions = 384, vectorCount = 1000) {
     ...
     */
    async benchmarkJSSimilarity(iterations = 10000) {
     ...
     */
    async benchmarkWASMSimilarity(iterations = 10000) {
        const mockDb = {
     ...
     */
    async benchmarkBatchSimilarity() {
        const mockDb = {
            prepare: () => ({ all: () => [], get: () => null, run: () => ({}) }),
            exec: () => { },
        };
    ...
    async runAll() {
        ...
        console.log('Results:');
        console.log('='.repeat(80));
        console.log('Benchmark'.padEnd(40) +
...
//# sourceMappingURL=wasm-vector-benchmark.js.map