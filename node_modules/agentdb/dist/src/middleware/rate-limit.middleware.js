 ...
 */
function createKeyGenerator(prefix = 'general') {
    return (req) => {
        const authReq = req;
 ...
 */
export function createRateLimiter(config, name = 'custom') {
    return rateLimit({
 ...
 */
export function createSlidingWindowRateLimiter(windowMs, maxRequests) {
