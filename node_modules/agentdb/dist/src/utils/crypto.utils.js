 ...
 */
export function generateSecureRandomHex(length = 32) {
    return generateSecureRandom(length).toString('hex');
}
/**
 * Generate URL-safe random string (base64url)
 */
export function generateSecureRandomBase64(length = 32) {
 ...
 */
export async function deriveKey(password, salt, iterations = 100000, keyLength = 32) {
