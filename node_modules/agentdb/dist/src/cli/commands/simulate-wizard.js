...
async function scenarioWizard() {
    ...
    const finalConfig = config.useOptimal
...
async function customWizard() {
    ...
    const finalConfig = { ...components, ...additionalConfig };
...
//# sourceMappingURL=simulate-wizard.js.map