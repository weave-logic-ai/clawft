 ...
 */
import { detectBackend, formatDetectionResult } from '../../backends/detector.js';
...
function printDetectionInfo(detection) {
...
export async function initCommand(options = {}) {
    const { backend = 'auto', dimension = 384, model, preset, inMemory = false, dryRun = false, dbPath = './agentdb.db' } = options;
    try {
