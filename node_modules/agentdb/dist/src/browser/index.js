...
// ============================================================================
export { ProductQuantization, createPQ8, createPQ16, createPQ32 } from './ProductQuantization';
// ============================================================================
// HNSW Indexing
// ============================================================================
export { HNSWIndex, createHNSW, createFastHNSW, createAccurateHNSW } from './HNSWIndex';
// ============================================================================
// Advanced Features
// ============================================================================
export { GraphNeuralNetwork, MaximalMarginalRelevance, TensorCompression, BatchProcessor } from './AdvancedFeatures';
// ============================================================================
// WASM Attention (Browser-Compatible)
// ============================================================================
export { AttentionBrowser, createAttention, createFastAttention, createAccurateAttention } from './AttentionBrowser';
// ============================================================================
// Feature Detection
// ============================================================================
/**
 ...
 */
export function estimateMemoryUsage(numVectors, dimension, config) {
 ...
 */
export function recommendConfig(numVectors, dimension) {
    if (numVectors < 1000) {
        return {
            name: 'SMALL_DATASET',
 ...
 */
export async function benchmarkSearch(searchFn, numQueries = 100, k = 10, dimension = 384) {
    const times = [];
