...
export class AttentionBrowser {
    ...
    consolidateMemoriesFallback(memories, config) {
        ...
        for (let i = 0; i < memories.length; i++) {
            ...
            if (consolidated.length >= maxClusters)
                break;
        }
        return consolidated;
    }
 ...
 */
export function createAccurateAttention() {
    return new AttentionBrowser({
        dimension: 768,
        numHeads: 8,
        blockSize: 128,
...
//# sourceMappingURL=AttentionBrowser.js.map