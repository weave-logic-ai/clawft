...
export class WASMVectorSearch {
    ...
    getWASMSearchPaths() {
        ...
        searchPaths.push(resolve(process.cwd(), 'wasm', 'reasoningbank', moduleName), resolve(process.cwd(), 'node_modules', '@ruvector', 'wasm', moduleName), resolve(process.cwd(), '..', 'agentic-flow', 'wasm', 'reasoningbank', moduleName));
